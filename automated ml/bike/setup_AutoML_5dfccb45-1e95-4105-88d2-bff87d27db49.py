...
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"9ce2b662-7db7-4b50-abb9-c9c7aa0d03c5\"}}" # PLACEHOLDER
...
automl_settings = {'enable_early_stopping':True,'enable_ensembling':True,'enable_stack_ensembling':True,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowDNN','TensorFlowLinearRegressor'],'whitelist_models':['LightGBM','RandomForest'],'compute_target':'ai-900','enable_dnn':False,'enable_code_generation':True,'experiment_exit_score':0.085,'experiment_timeout_minutes':30,'featurization':{'_blocked_transformers':[],'_column_purposes':{},'_transformer_params':{'Imputer':[]},'_drop_columns':None},'hyperdrive_config':None,'grain_column_names':None,'is_timeseries':False,'iteration_timeout_minutes':30,'max_concurrent_iterations':2,'metric_operation':'minimize','model_explainability':True,'n_cross_validations':None,'name':'mslearn-bike-rental','path':'./sample_projects/mslearn-bike-rental','primary_metric':'normalized_root_mean_squared_error','region':'centralindia','resource_group':'demo_student','subscription_id':'d0050e34-23d5-4bae-9e2b-59eb785a2188','task_type':'regression','validation_size':None,'test_size':None,'vm_type':'STANDARD_DS11_V2','workspace_name':'iacdrops','label_column_name':'rentals','save_mlflow':True,'enable_batch_run':True,'dataset_id':'9ce2b662-7db7-4b50-abb9-c9c7aa0d03c5'} # PLACEHOLDER for AutoMLSettings
